...
const IconData kHomeIconData = Icons.home;
const Icon kFavouriteIcon = Icon(Icons.favorite);
const IconData kFavouriteIconData = Icons.favorite;
...
// Social Networks
FaIcon kInstagramDark = FaIcon(FontAwesomeIcons.instagram, color: kBlack);
...
// Add new post Screen
final Icon kGalleryIcon = Icon(Icons.camera_alt, color: kBlack);
